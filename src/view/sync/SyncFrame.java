...
public final class SyncFrame extends JFrame {
    ...
    private SyncFrame() {
        ...
        this.buttonsPan.setLayout(new BoxLayout(this.buttonsPan,
                BoxLayout.LINE_AXIS));
        ...
        this.upButton.addActionListener(new SyncActionListener(Synchronize.UP,
                this));
        this.downButton.addActionListener(new SyncActionListener(
                Synchronize.DOWN, this));
    ...
    public class SyncActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            Synchronize.sync(way, sf.getCommandeCB().isSelected(), sf
                    .getStockCB().isSelected(), sf.getAchatVenteCB()
                    .isSelected(), sf.getTresorCB().isSelected(), sf
                    .getMenuPlatCB().isSelected());
        }
